...
export function StatusBar({ coords, zoom, counts, spaceWeather }: StatusBarProps) {
  ...
  return (
    <div className="flex h-[var(--statusbar-height)] items-center justify-between gap-3 border-t border-[var(--border-color)] bg-black/30 px-3 font-mono text-[11px] text-slate-400">
      <div>
